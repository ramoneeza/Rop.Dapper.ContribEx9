...
namespace xUnit.Rop.Dapper.ContribEx9
{
    public partial class DapperHelperExtendTest
    {
        ...
        private IDbConnection _getOpenConnection()
        {
        ...
        public void ExplicitKeyPropertiesCacheTest()
        {
            ...
            Assert.Single(explicitkeys);
            // Double explicit Key
            explicitkeys=DapperHelperExtend.ExplicitKeyPropertiesCache(typeof(PartialKey1));
            Assert.Empty(explicitkeys);
        }
        [Fact]
        public void KeyPropertiesCacheTest()
        {
            ...
            // Double Key
            var partialkey=DapperHelperExtend.GetPartialKey(typeof(Maniobra));
        ...
        {
            var formatter = DapperHelperExtend.GetFormatter(_getConnection());
